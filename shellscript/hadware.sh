                ...
                function softwares () {
                	TIME=3
                        ...
                        echo "Escolha uma opção abaixo para listar os programas!
                         ...
                         3 - Listar programas do Arch
                         4 - Instalar programas padrões
                         5 - Voltar ao sistema"
                         echo " "
                         echo -n "Opção escolhida: "
                         read alternative
                         case $alternative in
                                 ...
                                 2)
                                        ...
                                        ;;
                                 3)
                                        echo Listando todos os programas instalados do Arch Linux.
                                        pacman -Qe > /tmp/programas.txt
                                        
                                        echo A lista de programas instalados foi gerada e está disponível no /tmp/programas.txt
                                        sleep $TIME
                                        ;;
                                 4)
